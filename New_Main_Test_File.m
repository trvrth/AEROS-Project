...
[t, r, v, DV_total, a, e] = ODE_Handle(DidymosIC(1:3), DidymosIC(4:6), Thrust, Array_Num, Num_SC, dt, mass_fuel_sc, mass_sc, Isp, M_A, Asteroid_Radius, Standoff_Distance, Ion_Beam_Divergence_Angle, Orbit_Window);
...
[~, final_RV] = ode45(@(t, y) propagate_WOT(t, y, mu), 0:dt:7e7, RV_finalIC, options);
